    ...
    <div class="box-body">
        ...
        <form class="form-horizontal" role="form" action="{{url('schedules/add')}}" method="post">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="name">Team 1:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="email">Team 2:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="contact">Pitch:</label>
                <div class="col-sm-10">
