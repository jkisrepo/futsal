...
<div class="box box-primary">
    ...
    <div class="box-body">
        <div class="box-header">
            ...
            <h3>{{config('strings.add_player_attendance')}}</h3>
        </div>
        <form class="form-horizontal" role="form" action="{{url('/attendance/players/add')}}" method="post">
...
@endsection
@section('js')
<script src="{{asset('dist/js/pages/add_player_attendance.js')}}"></script>
@endsection
