...
<body class="hold-transition login-page">
    <div class="login-box">
        ...
        <div class="login-box-body">
            <h3 class="login-box-msg">Sign in to start your session2</h3>
            @if(session('warning'))
            ...
            <form action="{{ route('login') }}" method="post">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4">
                        ...
                        <button type="button"  class="btn btn-danger btn-block btn-flat" style="width:auto; float:left" onclick="window.location='{{ url("/register") }}'">Register For Business</button>
                    </div>
