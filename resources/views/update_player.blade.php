    ...
    <div class="box-body">
        ...
        <form class="form-horizontal " role="form" action="{{url('players/'.$player->id.'/update')}}" method="post"
            ...
            <div class="col-sm-8">
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="contact">No. of Player:</label>
                    <div class="col-sm-10">
                        <input class="form-control" required name="parent" placeholder="No. of Player"
                ...
                <div class="form-group">
                    <label class="control-label col-sm-2" for="address">Date Of Registered:</label>
                    <div class="col-sm-10">
                        <input type="text" name="dob" required id="datetimepicker1" class="form-control"
                            placeholder="Choose Date Of Registered" value="{{$player->dob}}">
                    </div>
                </div>
                <div class="form-group">
