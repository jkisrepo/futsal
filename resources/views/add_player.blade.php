...
<div class="box box-primary">
    ...
    <div class="box-body">
        ...
        <form class="form-horizontal" role="form" action="{{url('players/add')}}" method="post"
            ...
            <div class="form-group">
                <label class="control-label col-sm-2" for="contact">No. of Players:</label>
                <div class="col-sm-10">
                    <input type="number" class="form-control" name="parent" placeholder="Enter Number of Players">
                </div>
            </div>
            <div class="form-group">
